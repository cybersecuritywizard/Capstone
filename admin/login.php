...
if(isset($_POST['login_btn'])){
  ...
  if (($admin_name && $password)) {
    $sql = "SELECT admin_id,admin_name, admin_email, admin_password FROM admins WHERE admin_name ='$admin_name' AND admin_password ='$password'  LIMIT 1";
          ...
          <div class="mx-auto container">
              <form id="login-form"   method="POST" action="login.php">
                ...
                <div class="form-group mt-2">
                    <label>Name</label>
                    <input type="Name" class="form-control" id="product-name" name="admin_name" placeholder="Name" required/>
                </div>
                  <div class="form-group mt-2">
